...
$sql="CREATE TABLE IF NOT EXISTS presence (
  ...
  data Date NOT NULL,
  hour_in varchar(8) NOT NULL default '08:30',
...
$sql="INSERT INTO presence (id_users, data, hour_in,hour_out) VALUES ('1', STR_TO_DATE('11/11/2013', '%m/%d/%Y'),'08:30','13:30'),".
"('1', STR_TO_DATE('11/12/2013', '%m/%d/%Y'),DEFAULT,'13:30'),".
"('1', STR_TO_DATE('11/13/2013', '%m/%d/%Y'),'08:30','13:30')";
